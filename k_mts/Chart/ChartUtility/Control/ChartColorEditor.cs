...
{
    // Reference  : http://www.codeproject.com/Articles/14823/ChartColorEditor-An-extension-to-the-ColorEditor-to-s
    // License : CPOL
    ...
    /// </summary>
    public class ChartColorEditor : ColorEditor
    {
        ...
        public class ColorUIWrapper
        {
            ...
            public ColorUIWrapper(ChartColorEditor colorEditor)
            {
