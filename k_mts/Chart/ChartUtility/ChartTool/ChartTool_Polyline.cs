...
{
    public class ChartTool_Polyline : ChartTool, IMouseEventHandler, IAnnotationEventHandler, IAnnotationEditor
    {
        #region Variable and Property

        ChartArea curArea;
        PolylineAnnotation curAnot;

        #endregion

        #region Constructor

        public ChartTool_Polyline() : base("Polyline") { }
        public ChartTool_Polyline(string name) : base(name) { }
        ...
        protected override void Initialize()
        {
            ...
            this.IsSizeAlwaysRelative = true;
            this.IsFreeDrawPlacement = true;
        ...
        private PolylineAnnotation _CreateAnnotation()
        {
            var anot = new PolylineAnnotation();
            ...
            anot.IsFreeDrawPlacement = this.IsFreeDrawPlacement;            
