...
namespace System.Windows.Forms
{
	public class MsgBox : Form
	{
		...
		#region [Method] Basic Show

		public static DialogResult Show(string message)
		{
			_msgBox = new MsgBox();
			_msgBox._lblMessage.Text = message;
			_msgBox._lblTitle.Text = _defaultTitle;
		...
		//{
		//	_msgBox = new OtsMsgBox();
		//	_msgBox._lblMessage.Text = message;
		//	_msgBox._lblTitle.Text = title;

		//	OtsMsgBox.InitButtons(Buttons.OK);
		//	OtsMsgBox.InitIcon(icon);

		//	_msgBox.Size = OtsMsgBox.MessageSize(message);
		//	_msgBox.ShowDialog();
		//	MessageBeep(0);
		//	return _buttonResult;
		//}
		...
		#region [Method] Pre-defined Show

		public static DialogResult YesNo(string message, string title)
		{
			return Show(message, title, Buttons.YesNo, Icon.Question);
		}

		public static DialogResult YesNo(string message)
		{
			return Show(message, _defaultTitle, Buttons.YesNo, Icon.Question);
		}

		public static DialogResult OkShield(string message, string title)
		{
			return Show(message, title, Buttons.OK, Icon.Shield);
		}

		public static DialogResult OkShield(string message)
		{
			return Show(message, _defaultTitle, Buttons.OK, Icon.Shield);
		}

		public static DialogResult OkWarning(string message, string title)
		{
			return Show(message, title, Buttons.OK, Icon.Warning);
		}

		public static DialogResult OkWarning(string message)
		{
			return Show(message, _defaultTitle, Buttons.OK, Icon.Warning);
		}

		public static DialogResult OkError(string message, string title)
		{
			return Show(message, title, Buttons.OK, Icon.Error);
		}

		public static DialogResult OkError(string message)
		{
			return Show(message, _defaultTitle, Buttons.OK, Icon.Error);
		}
